    ...
    <div v-if="isLoaded">
      ...
      <form>
          ...
          <div v-if="isInstructor">
            ...
            <div class="col-auto">
              <button @click="updateInstructor" class="btn btn-primary mb-3">Save user info</button>
            </div>
          </div>
          ...
          <div v-if="makeInstructor">
            ...
            <div class="col-auto">
              <button @click="createInstructor" class="btn btn-primary mb-3">Create instructor</button>
            </div>
          </div>
        </form>
